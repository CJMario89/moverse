...
class MoverseControls {

	constructor( object, domElement ) {

		if ( domElement === undefined ) {

			console.warn( 'THREE.MoverseControls: The second parameter "domElement" is now mandatory.' );
			domElement = document;
...
//     if(isMouseDown){
//         if(mouseX != e.offsetX){
//             if(Math.abs(mouseX - e.offsetX) > 200){
//                 rotateX = 0.0011 * 10;
//             }else{
//                 rotateX = 0.0011 * (mouseX - e.offsetX);
//             }
//             mouseX = e.offsetX;
//         }else{
//             rotateX = 0;
...
//     scene.rotation.y += rotateX;
// }

export { MoverseControls };
