...
import { NearestFilter, WebGLRenderTarget as WebGLRenderTarget2 } from '/node_modules/three/build/three.module.js';

// src/materials/AdaptiveLuminanceMaterial.js
import { NoBlending, ShaderMaterial, Uniform } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending2, ShaderMaterial as ShaderMaterial2, Uniform as Uniform2, Vector2, Vector4 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking, NoBlending as NoBlending3, PerspectiveCamera, ShaderMaterial as ShaderMaterial3, Uniform as Uniform3 } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending4, ShaderMaterial as ShaderMaterial4, Uniform as Uniform4, Vector2 as Vector22 } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending5, ShaderMaterial as ShaderMaterial5, Uniform as Uniform5 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking2, NoBlending as NoBlending6, PerspectiveCamera as PerspectiveCamera2, ShaderMaterial as ShaderMaterial6, Uniform as Uniform6 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking3, NoBlending as NoBlending7, ShaderMaterial as ShaderMaterial7, Uniform as Uniform7, Vector2 as Vector23 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking4, NoBlending as NoBlending8, ShaderMaterial as ShaderMaterial8, Uniform as Uniform8, Vector2 as Vector24 } from '/node_modules/three/build/three.module.js';
...
var DepthDownsamplingMaterial = class extends ShaderMaterial8 {
  ...
  setDepthBuffer(buffer, depthPacking = BasicDepthPacking4) {
    this.uniforms.depthBuffer.value = buffer;
    this.defines.DEPTH_PACKING = depthPacking.toFixed(0);
    this.needsUpdate = true;
  }
...
import { BasicDepthPacking as BasicDepthPacking6, NoBlending as NoBlending10, ShaderMaterial as ShaderMaterial10, Uniform as Uniform10, Vector2 as Vector25 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking7, NoBlending as NoBlending11, PerspectiveCamera as PerspectiveCamera3, REVISION, ShaderMaterial as ShaderMaterial11, Uniform as Uniform11, Vector2 as Vector26 } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending12, ShaderMaterial as ShaderMaterial12, Uniform as Uniform12 } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending13, ShaderMaterial as ShaderMaterial13, Uniform as Uniform13 } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending14, ShaderMaterial as ShaderMaterial14, Uniform as Uniform14, UnsignedByteType } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending15, ShaderMaterial as ShaderMaterial15, Uniform as Uniform15, Vector2 as Vector27 } from '/node_modules/three/build/three.module.js';
...
import { NoBlending as NoBlending16, ShaderMaterial as ShaderMaterial16, Uniform as Uniform16, Vector2 as Vector28 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking8, Matrix4, NoBlending as NoBlending17, PerspectiveCamera as PerspectiveCamera4, ShaderMaterial as ShaderMaterial17, Uniform as Uniform17, Vector2 as Vector29 } from '/node_modules/three/build/three.module.js';
...
import { LinearFilter, UnsignedByteType as UnsignedByteType2, WebGLRenderTarget } from '/node_modules/three/build/three.module.js';

// src/passes/Pass.js
import { BufferAttribute, BufferGeometry, Camera, Mesh, Scene } from '/node_modules/three/build/three.module.js';
...
import { Color as Color2, MeshDepthMaterial, NearestFilter as NearestFilter2, RGBADepthPacking, WebGLRenderTarget as WebGLRenderTarget3 } from '/node_modules/three/build/three.module.js';

// src/core/Resolution.js
import { EventDispatcher, Vector2 as Vector210 } from '/node_modules/three/build/three.module.js';
var AUTO_SIZE = -1;
...
import { BackSide, DoubleSide, FrontSide } from '/node_modules/three/build/three.module.js';
...
var DepthPass = class extends Pass {
  constructor(scene, camera, {
    ...
    clearPass.setOverrideClearColor(new Color2(16777215));
...
import { BasicDepthPacking as BasicDepthPacking9, FloatType, NearestFilter as NearestFilter3, WebGLRenderTarget as WebGLRenderTarget4 } from '/node_modules/three/build/three.module.js';
...
import { FloatType as FloatType3, RGBADepthPacking as RGBADepthPacking3 } from '/node_modules/three/build/three.module.js';
...
var DepthCopyPass = class extends Pass {
  constructor({ depthPacking = RGBADepthPacking2 } = {}) {
    ...
    this.renderTarget = new WebGLRenderTarget5(1, 1, {
      type: depthPacking === RGBADepthPacking2 ? UnsignedByteType3 : FloatType2,
...
var DepthPickingPass = class extends DepthCopyPass {
  constructor({ depthPacking = RGBADepthPacking3, mode = DepthCopyMode.SINGLE } = {}) {
    super({ depthPacking });
...
import { BasicDepthPacking as BasicDepthPacking12, UnsignedByteType as UnsignedByteType4 } from '/node_modules/three/build/three.module.js';
...
import { EventDispatcher as EventDispatcher2, Uniform as Uniform18 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking11, EventDispatcher as EventDispatcher3, Scene as Scene2 } from '/node_modules/three/build/three.module.js';
var EffectAttribute = {
  NONE: 0,
  DEPTH: 1,
  CONVOLUTION: 2
...
import { LinearFilter as LinearFilter2, UnsignedByteType as UnsignedByteType5, WebGLRenderTarget as WebGLRenderTarget6 } from '/node_modules/three/build/three.module.js';
var kernelPresets = [
...
import { LinearFilter as LinearFilter3, UnsignedByteType as UnsignedByteType6, WebGLRenderTarget as WebGLRenderTarget7 } from '/node_modules/three/build/three.module.js';
...
import { Color as Color3, MeshNormalMaterial, NearestFilter as NearestFilter5, WebGLRenderTarget as WebGLRenderTarget8 } from '/node_modules/three/build/three.module.js';
...
import { UnsignedByteType as UnsignedByteType7 } from '/node_modules/three/build/three.module.js';
...
var EffectComposer = class {
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    const size = this.renderer === null ? new Vector211() : this.renderer.getDrawingBufferSize(new Vector211());
    const options = {
    ...
    let renderTarget;
    if (multisampling > 0) {
      renderTarget = Number(REVISION2.replace(/\D+/g, "")) < 138 ? new WebGLMultisampleRenderTarget(size.width, size.height, options) : new WebGLRenderTarget9(size.width, size.height, options);
...
import { LinearFilter as LinearFilter5, Uniform as Uniform19, WebGLRenderTarget as WebGLRenderTarget10 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform20 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform21 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform22 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform23, Vector2 as Vector212 } from '/node_modules/three/build/three.module.js';
...
import { BasicDepthPacking as BasicDepthPacking13, LinearFilter as LinearFilter6, Uniform as Uniform24, UnsignedByteType as UnsignedByteType8, WebGLRenderTarget as WebGLRenderTarget11 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform25, Vector2 as Vector213 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform26 } from '/node_modules/three/build/three.module.js';
...
import { NearestFilter as NearestFilter6, RepeatWrapping, RGBAFormat as RGBAFormat2, Uniform as Uniform27, Vector2 as Vector214 } from '/node_modules/three/build/three.module.js';
...
var GodRaysEffect = class extends Effect {
  constructor(camera, lightSource, {
    ...
    this.renderPassLight.getClearPass().setOverrideClearColor(new Color4(0));
    this.clearPass = new ClearPass(true, false, false);
    this.clearPass.setOverrideClearColor(new Color4(0));
    this.blurPass = new KawaseBlurPass({ resolutionScale, width, height, kernelSize });
...
import { Uniform as Uniform29, Vector2 as Vector216 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform30, Vector3 as Vector32 } from '/node_modules/three/build/three.module.js';
...
var LUTEffect = class extends Effect {
  constructor(lut, { blendFunction = BlendFunction.NORMAL, tetrahedralInterpolation = false } = {}) {
    ...
    this.outputEncoding = sRGBEncoding2;
  ...
  setLUT(lut) {
    ...
    if (this.getLUT() !== lut) {
      ...
      if (lut.type === FloatType5 || lut.type === HalfFloatType) {
...
import { Color as Color6, LinearFilter as LinearFilter10, RepeatWrapping as RepeatWrapping2, Uniform as Uniform32, UnsignedByteType as UnsignedByteType12, WebGLRenderTarget as WebGLRenderTarget13 } from '/node_modules/three/build/three.module.js';
...
function getTextureDecoding(texture, isWebGL2) {
  let decoding = "texel";
  if (texture !== null) {
    const revision = Number.parseInt(REVISION3);
    const sRGB8Alpha8 = isWebGL2 && revision >= 133 && revision !== 135 && texture.format === RGBAFormat4 && texture.type === UnsignedByteType11 && texture.encoding === sRGBEncoding3;
    if (!sRGB8Alpha8) {
...
var OutlineEffect = class extends Effect {
  constructor(scene, camera, {
    ...
    this.clearPass = new ClearPass();
    this.clearPass.setOverrideClearColor(new Color6(0));
    ...
    clearPass.setOverrideClearColor(new Color6(16777215));
    clearPass.setOverrideClearAlpha(1);
    this.blurPass = new KawaseBlurPass({ resolutionScale, width, height, kernelSize });
    this.blurPass.setEnabled(blur);
    const resolution = this.blurPass.getResolution();
...
import { Uniform as Uniform33, Vector2 as Vector217 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform34, Vector4 as Vector42 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform35, Vector2 as Vector218 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform36, Vector2 as Vector219, Vector3 as Vector35 } from '/node_modules/three/build/three.module.js';
...
var SelectiveBloomEffect = class extends BloomEffect {
  constructor(scene, camera, options) {
    ...
    this.depthPass = new DepthPass(scene, camera);
    this.clearPass = new ClearPass(true, false, false);
    this.clearPass.setOverrideClearColor(new Color7(0));
    this.depthMaskPass = new ShaderPass(new DepthMaskMaterial());
    const depthMaskMaterial = this.depthMaskPass.getFullscreenMaterial();
    depthMaskMaterial.setDepthBuffer1(this.depthPass.getTexture(), RGBADepthPacking4);
  ...
  isInverted() {
    return this.getDepthMaskMaterial().getDepthMode() === NotEqualDepth2;
  }
  setInverted(value) {
    this.getDepthMaskMaterial().setDepthMode(value ? NotEqualDepth2 : EqualDepth2);
  }
...
import { Uniform as Uniform37 } from '/node_modules/three/build/three.module.js';
...
var SMAAEffect = class extends Effect {
  constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
    ...
    this.clearPass = new ClearPass(true, false, false);
    this.clearPass.setOverrideClearColor(new Color8(0));
    this.clearPass.setOverrideClearAlpha(1);
    this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new Vector220(), edgeDetectionMode));
...
import { Uniform as Uniform40, UnsignedByteType as UnsignedByteType13 } from '/node_modules/three/build/three.module.js';
  ...
  setTexture(value) {
    ...
    if (prevTexture !== value) {
      ...
      if (value !== null) {
        ...
        if (value.type !== UnsignedByteType13) {
...
import { LinearFilter as LinearFilter14, LinearMipMapLinearFilter, LinearMipmapLinearFilter, Uniform as Uniform41, WebGLRenderTarget as WebGLRenderTarget17 } from '/node_modules/three/build/three.module.js';
...
import { Uniform as Uniform42 } from '/node_modules/three/build/three.module.js';
...
import { LoadingManager } from '/node_modules/three/build/three.module.js';
...
import { FileLoader, Loader, LoadingManager as LoadingManager2 } from '/node_modules/three/build/three.module.js';
...
import { FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager3, Vector3 as Vector36 } from '/node_modules/three/build/three.module.js';
...
import { Loader as Loader3, LoadingManager as LoadingManager4 } from '/node_modules/three/build/three.module.js';
